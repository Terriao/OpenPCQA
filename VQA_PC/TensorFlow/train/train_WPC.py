...
if __name__ == '__main__':
    ...
    # training parameters
    parser.add_argument('--conv_base_lr', type=float, default=0.00004) #0.00005效果不好，震荡
    parser.add_argument('--decay_ratio', type=float, default=0.9)
    parser.add_argument('--decay_interval', type=int, default=10)
    parser.add_argument('--train_batch_size', type=int, default=16)
    # parser.add_argument('--num_workers', type=int, default=3)
    parser.add_argument('--epochs', type=int, default=40)#30效果不好
    ...
    # misc
    parser.add_argument('--ckpt_path', type=str, default='/userhome/VQA_PC-main/tensorflow/train/WPC_ckpts/')
